    ...
    def log_episode(self, episode: Episode, step: int, mode: str = "train", epoch: int = 0):
        ...
        for traj in episode.trajectories:
            traj_data = {
                ...
                "reward_details": traj.info.get("reward_details", {}),  # Add fine-grained reward details
                "steps": [
                    {
                        ...
                        "log_snapshot": step.info.get("log_snapshot", {}),  # Add review log snapshot
                        "syntactic_reward": step.info.get("syntactic_reward"),  # Add per-step syntactic reward
                    }
